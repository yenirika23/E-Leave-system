...
@section('breadcrumb', 'Atasan › Detail Pengajuan')
...
<script>
    function submitApproval(action) {
        if (action === 'ditolak' && !document.getElementById('rejectionReason').value.trim()) {
            alert('Harap isi alasan penolakan.');
            return;
        }

        if (!confirm(action === 'disetujui' ? 'Setujui pengajuan ini?' : 'Tolak pengajuan ini?')) {
            return;
        }
